...
## 4. Exhaustive Spring Boot (`start.spring.io`) Official Starters Catalog
...
## 5. Exhaustive Node.js / TypeScript Ecosystem (NestJS & Next.js)
...
## 6. Exhaustive Python AI & Microservice Ecosystem (FastAPI)
...
2. **Expand `src/pages/canvas/components/EdgeInspector.tsx`:**
   - When a Spring Boot / NestJS / FastAPI node is selected, render expandable accordion groups with nested checkboxes from this catalog
