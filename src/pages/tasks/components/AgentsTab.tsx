...
export default function AgentsTab() {
  ...
  const WorkflowFlow = () => (
    <div className="flex items-center gap-1 flex-wrap">
          <div className="flex items-center gap-1.5 px-3 py-2 bg-slate-100 border border-slate-200 rounded-lg text-xs font-semibold text-slate-600"><FileText size={13} /> Task</div>
          {flow.map((a) => (
